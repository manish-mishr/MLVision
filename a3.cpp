...
vector<string> files_in_directory(const string &directory,
...
int main(int argc, char **argv) {
	try {
		...
		for (vector<string>::const_iterator c = class_list.begin(); c
				!= class_list.end(); ++c)
		...
		if (algo == "nn")
			...
			classifier = new svm_viola_jones(class_list);
